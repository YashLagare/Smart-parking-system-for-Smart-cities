...
export const metadata: Metadata = {
  title: "SmartPark AI - Enterprise Smart City Parking SaaS Platform",
  description: "AI-Powered real-time parking space optimization, dynamic pricing, and navigation.",
};
